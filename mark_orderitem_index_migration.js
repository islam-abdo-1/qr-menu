...
const checkSql = `SELECT 1 FROM "_prisma_migrations" WHERE migration_name = '20260823000001_add_orderitem_composite_index'`;
const insertSql = `
INSERT INTO "_prisma_migrations" (id, migration_name, finished_at, rolled_back_at, logs, started_at, applied_steps_count, checksum)
VALUES (
    gen_random_uuid(),
    '20260823000001_add_orderitem_composite_index',
    NOW(),
    NULL,
    'Added composite index on OrderItem (itemId, orderId) for best sellers query',
    NOW(),
    1,
    'manual-fix'
);
