...
- Name: public\menu.spec.ts >> Public Menu - Customer Flow >> menu loads with hero and sections
- Location: test\e2e\public\menu.spec.ts:8:7
...
Locator: locator('text=الأكثر مبيعًا, text=SHAKES, text=COOLERS').first()
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('text=الأكثر مبيعًا, text=SHAKES, text=COOLERS').first() with timeout 10000ms
  - waiting for locator('text=الأكثر مبيعًا, text=SHAKES, text=COOLERS').first()
