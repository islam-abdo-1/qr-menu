...
const checkSql = `SELECT 1 FROM "_prisma_migrations" WHERE migration_name = '20260823000002_remove_favorite_model'`;
const insertSql = `
INSERT INTO "_prisma_migrations" (id, migration_name, finished_at, rolled_back_at, logs, started_at, applied_steps_count, checksum)
VALUES (
    gen_random_uuid(),
    '20260823000002_remove_favorite_model',
    NOW(),
    NULL,
    'Removed unused Favorite model and table',
    NOW(),
    1,
    'manual-fix'
);
